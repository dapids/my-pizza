          ...
          <ul className={styles.steps}>
            ...
            <li>
              <Translation
                language={language}
                translations={{
                  en: `Incorporate the flour a little at a time with your hand. The gradualness of the process is important to avoid the formation of lumps.`,
                  it: `Incorporiamo la farina un po' alla volta con la mano. La gradualità del processo è importante per evitare la formazione di grumi.`,
                }}
              />
            </li>
            <li>
              <Translation
                language={language}
                translations={{
                  en: `Work the dough with your hands so that it takes air. During processing it is important to squeeze it by pulling it upwards.`,
                  it: `Lavoriamo l'impasto con le mani in modo che prenda aria. Durante la lavorazione è importante mozzarlo, ovvero strizzarlo tirandolo verso l'alto.`,
                }}
              />
            </li>
            <li>
              <Translation
                language={language}
                translations={{
                  en: `Add the water with the yeast.`,
                  it: `Aggiungiamo l'acqua con il lievito.`,
                }}
              />
            </li>
            <li>
              <Translation
                language={language}
                translations={{
                  en: `Incorporate another ${flourGramsSecondPart} grams of flour.`,
                  it: `Incorporiamo altri ${flourGramsSecondPart} grammi di farina.`,
                }}
              />
            </li>
            <li>
              <Translation
                language={language}
                translations={{
                  en: `Work the dough for 5-10 minutes until it comes off well from the kneading trough.`,
                  it: `Lavoriamo l'impasto per 5-10 minuti finché non si stacca bene dalla madia.`,
                }}
              />
            </li>
            <li>
